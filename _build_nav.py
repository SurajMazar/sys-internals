...
COURSES = {
 ...
 "aws": {
  "name":"AWS Certification Prep","page":"course-aws.html","accent":"#ff9900","prefix":"aws-",
  "ch":["Exam Overview & Study Strategy",
        "IAM & Account Security Fundamentals",
        "VPC Networking Fundamentals",
        "EC2 & Compute Choices",
        "EBS, Instance Store & Storage Choices",
        "S3 Deep Dive: Storage Classes, Lifecycle & Security",
        "Elastic Load Balancing & Auto Scaling",
        "RDS, Aurora & Database Choices",
        "DynamoDB Deep Dive",
        "Serverless: Lambda, API Gateway & Step Functions",
        "Messaging & Decoupling: SQS, SNS & EventBridge",
        "Content Delivery & DNS: CloudFront & Route 53",
        "Resilience & Disaster Recovery",
        "Cost Optimization Fundamentals",
        "Associate-Level Practice Exam & Exam-Day Strategy",
        "Multi-Account Strategy: Organizations, Control Tower & SCPs",
        "Advanced Networking: Transit Gateway, Direct Connect & Hybrid Connectivity",
        "Migration Strategies: The 7 Rs & Migration Tooling",
        "Advanced Security: KMS, Secrets Manager, GuardDuty & Security Automation",
        "Deployment & CI/CD at Scale: CodePipeline, Blue/Green & Canary Strategies",
        "Advanced Cost Optimization & Governance at Scale",
        "Observability at Scale: CloudWatch, X-Ray & Centralized Logging",
        "Professional-Level Practice Exam & Complex Scenario Walkthroughs",
        "Capstone: Design a Multi-Tier, Multi-Account Architecture End to End"]},
}
