...
import storyboardAws14 from "./content/aws-14.storyboard.json";
import durationsAws14 from "./content/aws-14.durations.json";
import storyboardAws15 from "./content/aws-15.storyboard.json";
